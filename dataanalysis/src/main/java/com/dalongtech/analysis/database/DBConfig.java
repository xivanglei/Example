package com.dalongtech.analysis.database;
...
class DBConfig {
    ...
    public static class TableAllInfo {
        ...
        public static class Column {
            ...
            public static final String INFO = "a";      //数据
            public static final String SIGN = "b";      //标记
            public static final String TYPE = "c";      //EventName
            public static final String INSERT_DATE = "d";       //插入时间
