package com.dalongtech.testapplication.component.transformanim;
...
public class ActivityAnimationHelper {
    ...
    private static void calculatePivotXY(View view, int[] location, Context context) {
        int screenCenterX = ScreenUtil.getScreenW() / 2;
        int screenCenterY = ScreenUtil.getScreenH() / 2;
        if (view != null) {
    ...
    public static void animScaleUp(final Activity activity, Intent intent,
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                LogUtil.d("animScaleUp(), onAnimationStart");
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                LogUtil.d("animScaleUp(), onAnimationEnd");
            }
    ...
    public static void animScaleDown(final Activity activity, final OnAnimationListener listener) {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
                LogUtil.d("animScaleDown(), onAnimationStart");
                ((TransformActivity)activity).stopDispatchKeyEvent(true);
                notifyAnimState(listener, ANIM_STATE_START);
            }

            @Override
            public void onAnimationEnd(Animation animation) {
                LogUtil.d("animScaleDown(), onAnimationEnd");
                notifyAnimState(listener, ANIM_STATE_END);
                activity.overridePendingTransition(0, 0);
            }
