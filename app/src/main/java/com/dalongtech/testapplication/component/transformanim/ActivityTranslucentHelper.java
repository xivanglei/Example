...
class ActivityTranslucentHelper {
    ...
    private static void convertActivityToTranslucentAfterL(Activity activity, PageTranslucentListener listener) {
        try {
            ...
            LogUtil.d("convertActivityToTranslucentAfterL true");
        } catch (Throwable t) {
            LogUtil.e("convertActivityToTranslucentAfterL error: " + t.getMessage());
            t.printStackTrace();
        }
    }
    ...
    private static void convertActivityToTranslucentBeforeL(Activity activity, PageTranslucentListener listener) {
        try {
            ...
            LogUtil.e("convertActivityToTranslucentBeforeL error: " + t.getMessage());
            t.printStackTrace();
        }
    }
    ...
    public static boolean convertActivityFromTranslucent(Activity activity) {
        try {
            ...
            LogUtil.d("convertActivityFromTranslucent true");
            return true;
        } catch (Throwable t) {
            LogUtil.e("convertActivityFromTranslucent error: " + t.getMessage());
            t.printStackTrace();
            return false;
        }
    }
