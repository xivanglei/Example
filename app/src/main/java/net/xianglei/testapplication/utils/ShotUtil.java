...
public class ShotUtil {
     ...
     * @return Bitmap
     */
    public static Bitmap shotActivity(AppCompatActivity context) {
     ...
     * @return Bitmap
     */
    public static Bitmap shotActivityNoStatusBar(AppCompatActivity activity) {
        // 获取windows中最顶层的view
        ...
        int heights = view.getMeasuredHeight();
